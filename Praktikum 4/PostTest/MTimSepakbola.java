...
* Deskripsi	: Kelas yang berisi program utama yang memanfaatkan kelas operasi TimSepakBola
* Lab		: B1
*/
...
class MTimSepakbola {
  public static void main(String[] args) {
    ...
    TimSepakbola manchesterUnited = new TimSepakbola("Manchaster United");
